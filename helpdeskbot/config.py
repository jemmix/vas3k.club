...
TELEGRAM_HELP_DESK_BOT_QUESTION_CHANNEL_DISCUSSION_ID = os.getenv(
    "TELEGRAM_HELP_DESK_BOT_QUESTION_CHANNEL_DISCUSSION_ID"
)
TELEGRAM_HELP_DESK_BOT_WEBHOOK_URL = os.getenv(
    "TELEGRAM_HELP_DESK_BOT_WEBHOOK_URL",
    "https://vas3k.club/telegram/helpdeskbot/webhook/",
)
